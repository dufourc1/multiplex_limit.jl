...
with_theme(theme_black()) do
    ...
    barplot!(ax1, 20:-1:1, prim_ener;
        ...
        colormap = Reverse(:viridis)        #colormap = cgrad(:Hiroshige, scale = exp10)[end:-1:1],#[:grey30, :gainsboro,:blue,:dodgerblue, :dodgerblue, :orange, :orangered, :firebrick, :yellow]
    )
    ...
    ax3.xtickformat = "{:s}"
    text!(ax3, energySectors[psor], position = tuple.(total[psor] .+ 100, 1:9),
        align = (:left, :center))
    xlims!(ax3, 0, 19_000)
