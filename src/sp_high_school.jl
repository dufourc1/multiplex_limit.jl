...
for path in [path_to_figure_folder]
    if !isdir(path)
        mkdir(path)
    end
end
...
# Load data
nodes_data = CSV.read(joinpath(path_to_data_folder,"sp_high_school/diaries.csv/nodes.csv"), DataFrame; normalizenames = true)
diaries = CSV.read(joinpath(path_to_data_folder,"sp_high_school/diaries.csv/edges.csv"), DataFrame; normalizenames = true)
facebook = CSV.read(joinpath(path_to_data_folder,"sp_high_school/facebook.csv/edges.csv"), DataFrame; normalizenames = true)
survey = CSV.read(joinpath(path_to_data_folder,"sp_high_school/survey.csv/edges.csv"), DataFrame; normalizenames = true)
contacts = CSV.read(joinpath(path_to_data_folder,"sp_high_school/proximity.csv/edges.csv"), DataFrame; normalizenames = true)
